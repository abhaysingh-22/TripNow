    ...
    >
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6 overflow-y-auto max-h-[calc(100vh-180px)] md:max-h-[calc(100vh-250px)] pb-24 md:pb-32">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <h4 className="text-lg md:text-xl font-bold">{driverData.name}</h4>
              <div className="flex items-center space-x-2 mt-1">
                <div className="flex items-center">
                  <StarIcon className="w-4 h-4 text-yellow-400 mr-1" />
                  <span className="font-semibold">{driverData.rating}</span>
                  <span className="text-gray-500 text-sm ml-1">({driverData.totalRides} rides)</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div className="col-span-2">
                  ...
                  <p className="font-bold text-lg tracking-wider">{driverData.numberPlate}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className={`flex items-center justify-between p-3 md:p-4 rounded-xl border ${
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className={`text-xs ${
                  ...
                  {selectedPayment === 'cash' ? 'Payment pending' : 'Payment done'}
                </p>
              </div>
            </div>
        ...
        >
          ...
          <p className="font-medium text-blue-900">Your driver is on the way!</p>
