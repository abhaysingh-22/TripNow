...
function UserLogin() {
  ...
  return (
    ...
    transition-colors duration-300 animate-fadeIn flex items-center justify-center p-4 sm:p-6 md:p-8`}>
      ...
      <div className={`w-full max-w-[calc(100%-2rem)] sm:max-w-[440px] mx-auto 
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <form onSubmit={submitHandler} className="space-y-4 sm:space-y-5">
            <div className="space-y-1.5 sm:space-y-2 group">
              <h3 className={`text-base sm:text-lg font-semibold transform transition-all duration-300
              group-hover:translate-x-1 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
                What's your email?
              </h3>
              <input
                required
          ...
          <p className={`text-center text-sm sm:text-base transform hover:scale-105 transition-all duration-300
